## AI Shop: A Seamless Shopping Experience Powered by the AI Stack, Redux Toolkit, and Material UI
...
<!-- ![ecommerce-banner](https://github.com/RishiBakshii/AI-ecommerce/blob/main/frontend/src/assets/images/banner3.jpg?raw=true) --> -->
...
- **AI Chatbox:**
  -Get AI Recommended Products to Shop
...
```bash
  git clone https://github.com/shrutikajha2603/OABSS.git
```
